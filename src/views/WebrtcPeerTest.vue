<template>
  <wallpaper-plus color="208,233,242">
    <el-row>
      <el-col :span="6" v-for="(item, index) in webrtcPeerTestService.streams" :key="index">
        <video
            :id="item.rtcDirec"
            autoplay="autoplay"
    ...
    <el-form class="login-container" label-position="left" label-width="0px">
      ...
      <el-form-item style="user-select: none;">
        <el-input
            type="text"
            placeholder="请输入用户标识..."
            v-model="webrtcPeerTestService.userId"
      ...
      <el-form-item style="user-select: none;">
        <el-input
            ...
            type="text"
            placeholder="请输入房间号..."
            v-model="webrtcPeerTestService.roomId"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item style="width: 100%">
        <el-button
            type="primary"
            @click="webrtcPeerTestService.connect()"
      ...
      <el-form-item style="width: 100%">
        <el-button
            ...
            @click="webrtcPeerTestService.disconnect()"
        >
          关闭websocket
        </el-button>
      </el-form-item>
